...
Cisco Instructor (ITN, SRWE, ENSA), with hands-on exposure to Cisco routers and switches through
years of teaching. This repository is my portfolio: a reference for interviewers to review the
network builds I've completed, backed by a <a href="./skills-matrix/README.md">Skills Matrix</a> of what I
already know. The <a href="./networking-roadmap/README.md">Networking Roadmap</a> is included as a study
